...
<div id="page-wrapper">
                <div class="row">
                <h3>Compagnes de mailing </h3>
                        <table class="table">
                            <thead class="thead-dark">
                                <tr>
                                <th scope="col">#</th>
                                <th scope="col">Nom Chart</th>
                                <th scope="col">Email destination</th>
                                <th scope="col" > Envoi via </th>
                            ...
                            @foreach ( $historiques as $historique )
                                ...
                                @foreach($chartes as $chart)
                                        @if ( $chart->id == $historique->chartId )
                                            {{ $chart->name }}
                                        @endif                                        
                                    @endforeach
                                ...
                                <td> @if($historique->type == "groupe") 
                                    @foreach($clients as $client)
                                        @if ( $client->id == $historique->clientId )
                                            {{ $client->email }}
                                        @endif                                        
                                    @endforeach
                                
                                
                                @else{{ $historique->email }} @endif</td>
